...
def get_args():
    ...
    # 常用
    parser.add_argument('--alias', type=str, default='model', help='实验的别名，用于保存权重和结果文件')
    ...
    parser.add_argument('--output_file', type=str, default=os.path.join(dataset_dir, 'submission.csv'))
